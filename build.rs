...
fn main() {
    ...
    let const_declarations = [
        const_declaration!(pub(crate) Z15_REPERTOIRE = z15_repertoire),
        const_declaration!(pub(crate) Z7_REPERTOIRE = z7_repertoire),
        const_declaration!(pub(crate) DECODE_LOOKUP_TABLE = decode_lookup_table),
    ].join("\n");
